...
class PDF extends TCPDF
{
    public function Header()
    {
        ...
        $this->Cell(6, 6, '', 'LR');
        $this->Cell(34, 6, '   ', 'TLRB');
        $this->Cell(34, 6, '     Vacation Leave', 'TLRB');
        $this->Cell(34, 6, '        Sick Leave', 'TLRB');
        $this->Cell(7, 6, '', 'LR');

        $this->SetFont('dejavusans', '', 14);
        $this->Cell(9, 6, '   ☐', 'L');
        $this->SetFont('helvetica', '', 10);
        $this->Cell(78, 6, " For disapproval due to __________________", 'R');
        $this->Ln();

        $this->SetFont('helvetica', 'I', 10);
        $this->Cell(6, 6, '', 'LR');
        $this->Cell(34, 6, '      Total Earned', 'TLRB');
        $this->Cell(34, 6, '   ', 'TLRB');
        $this->Cell(34, 6, '   ', 'TLRB');
        $this->Cell(7, 6, '', 'LR');
        $this->Cell(87, 6, "         _____________________________________", 'LR');
        $this->Ln();

        $this->SetFont('helvetica', 'I', 10);
        $this->Cell(6, 6, '', 'LR');
        $this->Cell(34, 6, ' Less this Application', 'TLRB');
        $this->Cell(34, 6, '   ', 'TLRB');
        $this->Cell(34, 6, '   ', 'TLRB');
        $this->Cell(7, 6, '', 'LR');
        $this->Cell(87, 6, "         _____________________________________", 'LR');
        ...
        $this->SetFont('helvetica', '', 10);
        $this->Cell(115, 6, '      ___________ days with pay', 'L');
        $this->Cell(87, 6, "         _____________________________________", 'R');
        $this->Ln();

        $this->SetFont('helvetica', '', 10);
        $this->Cell(115, 6, '      ___________ days without pay', 'L');
        $this->Cell(87, 6, "         _____________________________________", 'R');
        $this->Ln();

        $this->SetFont('helvetica', '', 10);
        $this->Cell(115, 6, '      ___________ others specify', 'L');
        $this->Cell(87, 6, "         _____________________________________", 'R');
        $this->Ln();
...
$pdf->SetSubject('Generated Application for Leave');
// $pdf->SetKeywords('');
