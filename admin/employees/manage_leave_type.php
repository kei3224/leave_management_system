                ...
                while ($row = $lt->fetch_assoc()):
                    ...
                    <tr>
                        <td class="text-center">
                            <div class="icheck-primary d-inline">
                                <input type="checkbox" class="check_item" id="select_<?php echo $row['id'] ?>"
                                    name="leave_type_id[]" value="<?php echo $row['id'] ?>" <?php echo in_array($row['id'], $leave_type_ids) ? 'checked' : '' ?>>
                        ...
                        <td>
                            <input type="number" step="any" name="leave_credit[]"
                                value="<?php echo (isset($ltc[$row['id']])) ? $ltc[$row['id']] : $row['default_credit'] ?>"
